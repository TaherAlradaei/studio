...
export const arStrings: Dictionary = {
  ...
  welcomePage: {
    ...
    captainSpeechText: "الكابتن حفص، مدرب معتمد مكرس لتنمية المواهب الجديدة، يؤمن بأن كل لاعب يمتلك إمكانات فريدة. 'مهمتي هي إشعال شغف كرة القدم في قلوب شبابنا. نحن لا ندرب اللاعبين فقط؛ بل نربي قادة المستقبل، ونغرس فيهم الانضباط والاحترام والسعي الدؤوب للتميز.'",
